...
Public Class CRL_Deployment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Dep_App.CRL_Deployment.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_datefrom_to() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRL_Deployment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRL_Deployment = New CRL_Deployment()
        rpt.Site = Me.Site
        Return rpt
    End Function
