...
Public Class techActivityForm
    ...
    Private Sub techActivityForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LSM_Connection()
        LSM_ConnectionPETC()
        comboTech.Items.Clear()
        comboPETC.Items.Clear()

        Dim tbl As New Tbluser
        Dim tblPetc As New TblPetc
    ...
    Private Sub btnSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        If comboPETC.Text = "" Then
            ErrorProvider1.SetError(comboPETC, "Please Select PETC")
            Exit Sub
        Else
            ErrorProvider1.Clear()
        End If
        ...
        If txtTask.Text = "" Then
            ErrorProvider1.SetError(txtTask, "Please type the problem or issues")
            Exit Sub
        Else
            ErrorProvider1.Clear()
        End If
        ...
        If txtSolution.Text = "" Then
            ErrorProvider1.SetError(txtSolution, "Please type your solution to the problem")
            Exit Sub
        Else
            ErrorProvider1.Clear()
        End If
                                ...
                                If listCode.Count > 0 Then
                                    For i = 0 To listCode.Count - 1
                                        ...
                                        Using UnitOfWorkAdd = Lsconn.CreateUnitOfWork
                                            ...
                                            tbl.Solutions = txtSolution.Text
